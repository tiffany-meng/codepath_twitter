...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "mVPoHDIQXgdwE8eLHWu2TQUgl", consumerSecret: "b2Dg3LzMqrEXqGvsQrazJUrnSQl39ggunrbPAmgOIG4I9Xop95")
    var loginSuccess: (() -> ())?
